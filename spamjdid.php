# Recode Modar!1!1!11!
<?php
//new spam by Mr.Kintil
//just beginner
//happy spamming:)
echo "\e[93mSPAM SMS JD.ID
\e[91m#########################
\e[91mCODED BY Mr.Kintil
Github : https://github.com/AnonymousAllIndonesia
\e[36m#########################";
...
for ($x=1; $x<=$loop; $x++) {
	...
	if ($hasil == "true") {
		...
		$loop += 1;
		echo "\e[91m$x. SPAMNYA GAGAL BGSD.......\n\e[97mCount +1\n".($loop-$x)." remaining\n\e[93mSleep in 60s\n";
		flush();
		sleep(60);
	}
}
echo "\e[91mSEE YOU SCRIPT KIDDIES\n";
?>
